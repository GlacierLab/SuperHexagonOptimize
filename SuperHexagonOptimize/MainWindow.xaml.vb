...
Class MainWindow
    ...
    Dim gamePath As String = System.Environment.CurrentDirectory
    ...
    Private Sub glutBtn_Click(sender As Object, e As RoutedEventArgs) Handles glutBtn.Click
        If (glutEnabled) Then
            ...
            FileSystem.Rename("glut32.dll.bak", "glut32.dll")
            glutBtn.Content = "启用glut优化 Enable glut optimization"
            glutEnabled = False
        Else
            FileSystem.Rename("glut32.dll", "glut32.dll.bak")
    ...
    Private Sub dpiBtn_Click(sender As Object, e As RoutedEventArgs) Handles dpiBtn.Click
        If (DPIEnabled) Then
            ...
            FileSystem.Rename("superhexagon.exe.bak", "superhexagon.exe")
            dpiBtn.Content = "启用DPI优化 Enable DPI optimization"
            DPIEnabled = False
        Else
            FileSystem.Rename("superhexagon.exe", "superhexagon.exe.bak")
